            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    ...
                    <p className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl font-heading">
                        コア業務に集中できる環境を、<br className="hidden sm:block" />オンラインで。
                    </p>
                ...
                <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
                    <div className="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-2">
                        {/* Service 1 */}
                        <div className="flex flex-col glass-card rounded-2xl p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
