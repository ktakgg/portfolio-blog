                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                        ...
                        <svg className="h-8 w-auto text-[#4A154B] fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M6 15a2 2 0 1 1-2-2 2 2 0 0 1 2 2zm1-2h-3v-3a2 2 0 1 1 3 3zm6-5a2 2 0 1 1 2-2 2 2 0 0 1-2 2zm-2 1h3v3a2 2 0 1 1-3-3zm-5 6a2 2 0 1 1 2 2 2 2 0 0 1-2-2zm1 2h-3v3a2 2 0 1 1 3-3zm12-5a2 2 0 1 1-2 2 2 2 0 0 1 2-2zm-1 2h3v3a2 2 0 1 1-3-3zM8.5 13H11v-2.5a2.5 2.5 0 0 1 2.5-2.5H11V5.5a2.5 2.5 0 0 0-5 0V8h2.5zM13 15.5V13h2.5a2.5 2.5 0 0 1 2.5 2.5V18h-2.5a2.5 2.5 0 0 1-2.5-2.5zM15.5 11H13v2.5a2.5 2.5 0 0 1-2.5 2.5H13v2.5a2.5 2.5 0 0 0 5 0V13h-2.5zM11 8.5V11H8.5a2.5 2.5 0 0 1-2.5-2.5V6h2.5a2.5 2.5 0 0 1 2.5 2.5z" />
                        </svg>
                        ...
                        <svg className="h-8 w-auto text-[#0079BF] fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M19.03 3.56H4.97A1.44 1.44 0 0 0 3.53 5v14.03c0 .8.64 1.34 1.44 1.34h14.06c.8 0 1.44-.54 1.44-1.34V5a1.44 1.44 0 0 0-1.44-1.44zm-8.66 12.06H6.66V6.25h3.71v9.37zm7.41-3.6H14.1V6.25h3.68v5.77z" />
                        </svg>

                        {/* Zoom */}
                        <svg className="h-8 w-auto text-[#2D8CFF] fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M14 10.15v3.7c0 .55.45 1 1 1h5.5c.55 0 1-.45 1-1v-3.7c0-.55-.45-1-1-1h-5.5c-.55 0-1 .45-1 1zM2 6h9c1.1 0 2 .9 2 2v8c0 1.1-.9 2-2 2H2c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2z" />
                        </svg>

                        {/* Google Meet */}
                        <svg className="h-8 w-auto text-[#00897B] fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2-5.5l-4-4h8v3.5l3.5-3.5v9l-3.5-3.5V16h-8l4-1.5z" />
                        </svg>

                        {/* Discord */}
                        <svg className="h-7 w-auto text-[#5865F2] fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M19.27 5.33C17.94 4.71 16.5 4.26 15 4a.09.09 0 0 0-.07.03c-.18.33-.39.76-.53 1.09a16.09 16.09 0 0 0-4.8 0c-.14-.34-.35-.76-.54-1.09c-.01-.02-.04-.03-.07-.03c-1.5.26-2.93.71-4.27 1.33c-.01 0-.02.01-.03.02c-2.72 4.07-3.47 8.03-3.1 11.95c0 .02.01.04.03.05c1.8 1.32 3.53 2.12 5.2 2.65c.03.01.06 0 .07-.02c.4-.55.76-1.13 1.07-1.74c.02-.04 0-.08-.04-.09c-.57-.22-1.11-.48-1.64-.78c-.04-.02-.04-.08.01-.11c.11-.08.22-.17.33-.25c.02-.02.05-.02.07-.01c3.44 1.57 7.15 1.57 10.55 0c.02-.01.05-.01.07.01c.11.09.22.17.33.26c.04.03.04.09-.01.11c-.52.31-1.07.56-1.64.78c-.04.01-.05.06-.04.09c.32.61.68 1.19 1.07 1.74c.03.01.06.02.09.01c1.72-.53 3.45-1.33 5.25-2.65c.02-.01.03-.03.03-.05c.44-4.53-.73-8.46-3.1-11.95c-.01-.01-.02-.02-.04-.02zM8.52 14.91c-1.03 0-1.89-.95-1.89-2.12s.84-2.12 1.89-2.12c1.06 0 1.9.96 1.89 2.12c0 1.17-.84 2.12-1.89 2.12zm6.97 0c-1.03 0-1.89-.95-1.89-2.12s.84-2.12 1.89-2.12c1.06 0 1.9.96 1.89 2.12c0 1.17-.85 2.12-1.89 2.12z" />
                        </svg>
                    </div>
                </motion.div>
            </div>
