              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-0">
                <div className="flex flex-1 gap-3 rounded-lg border border-[#dbdbdb] bg-neutral-50 p-4 flex-col">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-[#141414] text-[22px] text-base font-bold leading-tight">オンライン経理サポート</h2>
                  </div>
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#dbdbdb] bg-neutral-50 p-4 flex-col">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-[#141414] text-[22px] text-base font-bold leading-tight">オンライン事務サポート</h2>
                  </div>
